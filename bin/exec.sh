...
rm -rf *.log result
mpirun -machinefile $PBS_NODEFILE -np $NPROCS /home/cml/marcell/DrugSimulation/bin/drug_sim \
	-input_deck EDISON_INPUT_DECK_SINGLE.txt \
	-hill_file ./drugs/quinidine/IC50_samples10.csv > logfile
